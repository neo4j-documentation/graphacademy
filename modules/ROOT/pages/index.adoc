...
1. **Neo4j Certified Professional** (60 minute exam with 80 questions): Tests Neo4j concepts, Cypher, and some basic data modeling.
2. **Neo4j 4.x Certified** (45 minute exam with 30 questions): Tests Neo4j 4.x features; must have passed the Neo4j Certified Professional exam. If you pass the **Neo4j Certified Professional** exam, you gain access to additional **advanced Neo4j training**.
