...
Each course will take you anywhere from 4 hours to 2 days to complete and includes hands-on exercises so you can gain experience with Neo4j.
...
After completing the *Introduction to Neo4j 4.0* course, you can take the *free 1-hour Neo4j Certified Professional exam*.
...
1. **Neo4j Certified Professional** (one hour exam with 80 questions): Tests Neo4j, Cypher, Data Modeling.
2. **Neo4j 4.0 Certified** (45 minute exam with 30 questions): Tests Neo4j 4.0 features; must have passed the Neo4j Certified Professional exam.
...
link:/graphacademy/neo4j-certification-40/[Take the Neo4j 4.0 Certified Exam, role=button course-action]
