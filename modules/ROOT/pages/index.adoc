...
1. **Neo4j Certified Professional** (60 minute exam with 80 questions): Tests Neo4j concepts, Cypher, and some basic data modeling. If you pass the **Neo4j Certified Professional** exam, you gain access to additional **advanced Neo4j training**.
